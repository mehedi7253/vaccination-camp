        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p class="text-center" style="font-size: 20px; color: white">Home <i class="fa fa-arrow-right"></i>Covid19 Vaccine</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12 mb-5">
                <h3 class="text-center p-5">{{ $page_name }}</h3>
                @foreach($corona as $vaccines)
                    <div class="col-md-4 col-sm-12 float-left mt-3">
                        <div class="card" style="border: 1px solid blue; height: 510px;">
                            <img src="{{ asset('corona/images/'.$vaccines->image) }}" style="height: 200px; width: 100%;">
                            ...
                            <div class="card-footer">
                                <a class="btn btn-info float-right" href="{{ route('pages.corona_reg', $vaccines->id) }}">Registration Now</a>
                            </div>
                        </div>
                    </div>
                @endforeach
