        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <p class="text-center" style="font-size: 20px; color: white">Home <i class="fa fa-arrow-right"></i> Make payment</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-8 mx-auto">
                            <div class="form-group">
                                ...
                                @foreach($doctor as $doctors)
                                    <input type="text" disabled  class="form-control" value="{{ $doctors->Payment }}">
                                @endforeach
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <a href="{{ route('pages.make_bakas_payment', $payment->id) }}"  class="btn col-md-5 p-1"  name="submit" style="background-color: #B6195E; color: white">Submit</a>
