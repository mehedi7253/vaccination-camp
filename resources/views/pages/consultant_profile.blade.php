        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <h1 class="text-center" style="font-size: 48px; font-weight: 600; margin-top: 150px; color: white"> Consultant</h1>
                    <p class="text-center" style="font-size: 20px; color: white">Home <i class="fa fa-arrow-right"></i> {{ $profile->name }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card mb-5 mt-5">
                    <div class="card-header">
                        <h3><span class="text-info">{{$profile->name}}</span> Profile</h3>
                    </div>
                    <div class="card-body">
                        <div class="col-md-4 col-sm-12 float-left">
                            <img src="{{ asset('consultant/images/'.$profile->image) }}" style="height: 280px; width: 100%"><br/>

                            <p class="text-center"><a href="{{ route('pages.get_appoint_ment_page',$profile->id) }}" class="btn btn-success mt-3 btn-block"><i class="fa fa-phone"></i> Book Appointment</a></p>
                        </div>
